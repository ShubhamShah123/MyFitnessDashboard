...
const WorkoutDetail = () => {
  ...
  const handleExerciseClick = (exercise: ExerciseDetail, day: string) => {
    ...
    if (typeof exercise.id === "number") {
      gifUrl = `/images/${day.toLowerCase()}_${exercise.id}.gif`;
    } else {
      gifUrl = `/images/${day.toLowerCase()}_${exercise.id.toLowerCase()}.gif`;
    }
    setModalData({
      title: exercise.exercise,
      body: `Sets: ${exercise.sets} | Reps: ${exercise.reps}`,
      exerciseGifUrl: gifUrl || "",
      exerciseDescription:
        exercise.desc || "No additional instructions available.",
    });
    setModalOpen(true);
  };
  ...
  return (
    <div className="WorkoutDetail">
                  ...
                  <tr key={`${groupNumber}-${exercise.id}-${index}`}>
                    ...
                    >
                      <div className="exercise-name">
                        {exercise.exercise}
                        {exercise.gifUrl && (
                          <span className="gif-indicator">🎬</span>
                        )}
                      </div>
                    </td>
      ...
      <ModalBox
        ...
        exerciseDescription={modalData.exerciseDescription}
      />
